...
document
  ...
  .addEventListener("click", function(event) {
    ...
    document.querySelector('.formulario').submit(); // Envía el formulario
  });
...
function verificarValores(event) {
  ...
  document.getElementById("ph-result").innerText = esPhOptimo ? "Óptimo" : "No óptimo";
  document.getElementById("turbiedad-result").innerText = esTurbiedadOptima ? "Óptimo" : "No óptimo";
  document.getElementById("cloro-result").innerText = esCloroOptimo ? "Óptimo" : "No óptimo";
  document.getElementById("nitratos-result").innerText = esNitratosOptimos ? "Óptimo" : "No óptimo";
  document.getElementById("cloruros-result").innerText = esClorurosOptimos ? "Óptimo" : "No óptimo";
  document.getElementById("fluor-result").innerText = esFluorOptimo ? "Óptimo" : "No óptimo";
  document.getElementById("sodios-result").innerText = esSodiosOptimos ? "Óptimo" : "No óptimo";
  document.getElementById("conductividad-result").innerText = esConductividadOptima ? "Óptimo" : "No óptimo";
  ...
  let icaValue = parseFloat(ica).toFixed(2);
  document.getElementById('ica-int').innerText = icaValue;
  document.getElementById('ica-value').value = icaValue;
}
